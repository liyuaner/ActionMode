# ActionMode
#这个文件一共有4工程，第一个是listview的用法，利用SimpleAdapter实现；第二个实验是自定义布局alertdialog；第三个是使用XML定义菜单；第四个是创建上下文操作模式actionmode的上下文菜单
![picture](https://github.com/liyuaner/ActionMode/blob/master/pic/Listview.png)
![picture](https://github.com/liyuaner/ActionMode/blob/master/pic/menu.PNG)
